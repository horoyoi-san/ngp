...
const checkdp = function(buff) {
    if (luastring_indexOf(buff, 46 ) < 0) {  
            ...
            switch (String.fromCharCode(strfrmt[i++])) {
                ...
                case 's': {
                    ...
                    if (form.length <= 2 || form[2] === 0) {  
                        ...
                        if (luastring_indexOf(form, 46 ) < 0 && s.length >= 100) {
...
const getoption = function(h, fmt) {
    ...
    switch (r.opt) {
        case 98  : r.size = 1; r.opt = Kint;   return r; 
        case 66  : r.size = 1; r.opt = Kuint;  return r;
        case 104 : r.size = 2; r.opt = Kint;   return r; 
        case 72  : r.size = 2; r.opt = Kuint;  return r;
        case 108 : r.size = 4; r.opt = Kint;   return r; 
        case 76  : r.size = 4; r.opt = Kuint;  return r;
        case 106 : r.size = 4; r.opt = Kint;   return r; 
        case 74  : r.size = 4; r.opt = Kuint;  return r;
        case 84  : r.size = 4; r.opt = Kuint;  return r; 
        case 102 : r.size = 4; r.opt = Kfloat; return r; 
        case 100 : r.size = 8; r.opt = Kfloat; return r; 
        case 110 : r.size = 8; r.opt = Kfloat; return r; 
        case 105 : r.size = getnumlimit(h, fmt, 4); r.opt = Kint;    return r; 
        case 73  : r.size = getnumlimit(h, fmt, 4); r.opt = Kuint;   return r;
        case 115 : r.size = getnumlimit(h, fmt, 4); r.opt = Kstring; return r;
        case 99  : {
            r.size = getnum(fmt, -1);
            if (r.size === -1)
        ...
        case 122 :             r.opt = Kzstr;      return r;
        case 120 : r.size = 1; r.opt = Kpadding;   return r;
        case 88  :             r.opt = Kpaddalign; return r;
        case 32  : break;
...
const match_class = function(c, cl) {
    switch (cl) {
        case 97  : return  isalpha(c);
        case 65  : return !isalpha(c);
        case 99  : return  iscntrl(c);
        case 67  : return !iscntrl(c);
        case 100 : return  isdigit(c);
        case 68  : return !isdigit(c);
        case 103 : return  isgraph(c);
        case 71  : return !isgraph(c);
        case 108 : return  islower(c);
        case 76  : return !islower(c);
        case 112 : return  ispunct(c);
        case 80  : return !ispunct(c);
        case 115 : return  isspace(c);
        case 83  : return !isspace(c);
        case 117 : return  isupper(c);
        case 85  : return !isupper(c);
        case 119 : return  isalnum(c);
        case 87  : return !isalnum(c);
        case 120 : return  isxdigit(c);
        case 88  : return !isxdigit(c);
        case 122 : return (c === 0);  
        case 90  : return (c !== 0);  
        default: return (cl === c);
    }
