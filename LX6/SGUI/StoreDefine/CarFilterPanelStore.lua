-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\CarFilterPanelStore.lua
-- Decompiled from: 01634_CarFilterPanelStore.lua_56e5deaf3361.luajit
...
M.OnClose = function(self)
	...
	self.CheckFilterMenuState(self)
end
...
M.RegisterWidget = function(self)
	...
	self.bindData.baseButton.luaClick = self.CreateAction(self, "OnClickBackBtn")
end

M.OnClickBackBtn = function(self)
	gUIUtils:PlayAniClosePanel(self.bindData.anim, "S_Vx_DressFilterPanel_close", self.m_Id)
end
...
M.OnChangeBrandList = function(self, btn, index)
	...
	elseif table.contains(gDressManager.SelectType.brand, data.brandId) then
		local idx = self.GetIndex(self, gDressManager.SelectType.brand, data.brandId)
