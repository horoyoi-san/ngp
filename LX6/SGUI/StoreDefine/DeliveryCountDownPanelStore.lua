-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\DeliveryCountDownPanelStore.lua
-- Decompiled from: 01701_DeliveryCountDownPanelStore.lua_d214813f1ddf.luajit
...
M.OnAwake = function(self)
	...
	self.timeRange = 0
	self.msgEvents = {
		[gEventConstants.ON_GOOD_COUNT_DOWN_FINISH] = self.CreateAction(self, self.ClosePanel)
	}
end
