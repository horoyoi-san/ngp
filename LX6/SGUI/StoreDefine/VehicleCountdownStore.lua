-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\VehicleCountdownStore.lua
-- Decompiled from: 01142_VehicleCountdownStore.lua_68de91cccb01.luajit
...
M.RefreshCountDown = function(self)
	...
	if self.needPlayLoopAni and self.remainTime < GameConfig.VehicleChasingUITime then
		...
		local aniSpeed = self.GetAnimSpeed(self, self.remainTime)

		SGUI.ExtensionMethod.SetAnimationSpeed(self.bindData.anim, "Vx_S_VehicleCountdown_1", aniSpeed)
	end
end

M.GetAnimSpeed = function(self, remainTime)
