-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\AnimalInteractionPanelStore.lua
-- Decompiled from: 01583_AnimalInteractionPanelStore.lua_732fb1d489cd.luajit
...
M.OnAwake = function(self)
	self.bindData.btn1.luaClick = self.CreateAction(self, "OnClickInteractBtn1")
	self.bindData.btn2.luaClick = self.CreateAction(self, "OnClickInteractBtn2")
	self.bindData.btn3.luaClick = self.CreateAction(self, "OnClickInteractBtn3")
	self.bindData.btnRename.luaClick = self.CreateAction(self, "OnRenameAnimal")
end
...
M.RefreshMenus = function(self, menus)
	self.renameMenu = nil
	self.interactMenus = {}
...
M.OnStart = function(self)
	self.RefreshInteractButtons(self)

	self.bindData.renameControl = 0
end

M.OnAnimalFavorChanged = function(self, menus)
	self.RefreshMenus(self, menus)
	self.RefreshInteractButtons(self)
end

M.RefreshInteractButtons = function(self)
...
M.SetDoingInteract = function(self, state)
	self.doingInteract = state
	self.bindData.interactStateCtrl = state and 1 or 0
end

M.ShowEmoji = function(self, emojiId, duration)
...
M.OnClickInteractBtn1 = function(self)
	self.OnClickInteractBtn(self, 1)
end

M.OnClickInteractBtn2 = function(self)
	self.OnClickInteractBtn(self, 2)
end

M.OnClickInteractBtn3 = function(self)
	self.OnClickInteractBtn(self, 3)
end

M.OnClickInteractBtn = function(self, index)
...
M.OnRenameAnimal = function(self)
