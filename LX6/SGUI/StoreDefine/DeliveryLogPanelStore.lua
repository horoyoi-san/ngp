-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\DeliveryLogPanelStore.lua
-- Decompiled from: 01846_DeliveryLogPanelStore.lua_6486c395438b.luajit
...
M.OnAwake = function(self)
	self.allMoney = 0
	self.bindData.logList.luaSimpleRenderItem = self.CreateAction(self, "OnRenderLogItem")
end
...
M.OnShow = function(self, panelId, data)
	...
	if data then
		self.InitLogList(self, data)
	end
end

M.InitLogList = function(self, data)
	self.historyInfos = {}
...
M.OnRenderLogItem = function(self, btn, index)
