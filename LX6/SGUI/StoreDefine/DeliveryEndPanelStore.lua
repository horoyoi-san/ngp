-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\DeliveryEndPanelStore.lua
-- Decompiled from: 01891_DeliveryEndPanelStore.lua_c9df33027f92.luajit
...
M.OnAwake = function(self)
	self.bindData.list.luaSimpleRenderItem = self.CreateAction(self, self.ListRenderItem)
end

M.ListRenderItem = function(self, btn, index)
...
M.OnShow = function(self, _, param)
...
M.InitDeliveryExp = function(self, truckJobOrderWrap)
...
M.GetOrderExp = function(self, truckJobOrderWrap)
...
M.GetDeliveryExp = function(self)
...
M.SetPointReward = function(self, data)
	local IntegralDescription = self.StringSplit(self, UberSimConfig.IntegralDescription, "|")
