-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\PowerMapHUDStore.lua
-- Decompiled from: 00800_PowerMapHUDStore.lua_a3a748adf6d8.luajit
...
M.OnDropBtnClick = function(self)
...
M.OnShow = function(self, panelId, data)
	...
	self.bindData.detailBtn.luaClick = self.CreateActionWithArgs(self, "OpenFactionMapWithSelection", factionId, self.mgr)

	self.RunLevelFrame(self, false)
end

M.RunLevelFrame = function(self, isNew)
