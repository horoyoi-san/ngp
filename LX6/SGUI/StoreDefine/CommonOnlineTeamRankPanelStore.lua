-- Original chunk: @Lua\LuaFiles\LX6\SGUI\StoreDefine\CommonOnlineTeamRankPanelStore.lua
-- Decompiled from: 01531_CommonOnlineTeamRankPanelStore.lua_47c741c286fc.luajit
...
C_CommonOnlineTeamRankPanelStore = DefClass("C_CommonOnlineTeamRankPanelStore", C_CommonOnlineTeamRankPanelStore, C_StoreGroup)
GroupName2Class.CommonOnlineTeamRankPanelStore = C_CommonOnlineTeamRankPanelStore
local M = C_CommonOnlineTeamRankPanelStore
local BOOL2CTL = {
	[true] = 1,
	[false] = 0
}
...
M.OnShow = function(self, panelId, data)
	if table.isNilOrEmpty(data) then
		print_error("CommonOnlineTeamRankPanelStore OnShow data is nil")
	...
	self.continueCallback = data.continueCallback
	self.bindData.showContinueCtrl = self.continueCallback and self.showContinueCtrlEnum.active or self.showContinueCtrlEnum.normal
...
M.OnClickContinueBtn = function(self)
	local continueCallback = self.continueCallback
