-- Original chunk: @Lua\LuaFiles\LX6\Data\Player\PlayerData\PlayerInfoItemData.lua
-- Decompiled from: 00096_PlayerInfoItemData.lua_b29caa364c75.luajit
...
M.DefineData = function(self)
	...
	self.pack = DataSet.New({
		["\\x86*\\xfe\\xa8A=\\xc5O\t\\xca\\xe2&\"_S\\xd85\\xbf\\xde"] = 0,
		itemUseTimes = {},
		itemShortcutDic = {}
	})
end
