-- Original chunk: @Lua\LuaFiles\LX6\Object\PickupUIObject.lua
-- Decompiled from: 00084_PickupUIObject.lua_58b7d42a3d39.luajit
...
local GetScreenPos = function(bornWorldPos)
...
PickupUIObject.TweenMove = function(self, middlePosFunc, targetPos, duration, easing, delay)
...
PickupUIObject.Update = function(self)
