-- Original chunk: @Lua\LuaFiles\LX6\Spoon\SpoonEnv.lua
-- Decompiled from: 00276_SpoonEnv.lua_393bf31be44a.luajit
...
SpoonUnit.ctor = function(self, getter)
	self.getter = getter
end

SpoonUnit.GetUnit = function(self)
	return self.getter()
end

SpoonUnit.IsMe = function(self)
...
SpoonWayPoint.ctor = function(self, x, y, z, facing, name, actionIndex)
...
SpoonDoor.ctor = function(self, name, px, py, pz, rx, ry, rz, sx, sy, sz, doorId, state)
	self.DoorId = doorId
...
SpoonTriggerEnemy.ctor = function(self, id, transform)
	self.Id = id
