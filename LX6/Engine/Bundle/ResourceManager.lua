-- Original chunk: @Lua\LuaFiles\LX6\Engine\Bundle\ResourceManager.lua
-- Decompiled from: 00154_ResourceManager.lua_d5ccb682faba.luajit
...
local M = {
	...
	EnterLoadingMode = function (self, loadingMode)
		self.Manager:EnterLoadingMode(loadingMode)
	end,
