-- Original chunk: @Lua\LuaFiles\LX6\Gameplay\Divination\DivinationClassDefine.lua
-- Decompiled from: 02270_DivinationClassDefine.lua_fbc1501b2411.luajit
...
CardEffectInfo.ctor = function(self, eventId, effectType, param1, param2, countDown, triggerNum, isNPC)
...
CardEffectInfo.Dispose = function(self)
	self.eventId = nil
	self.effectType = nil
	self.param1 = nil
	self.param2 = nil
...
HandCardInfo.ctor = function(self, cfg)
	self.cfg = cfg
	self.cost = cfg.Cost
...
HandCardInfo.Dispose = function(self)
	self.cfg = nil
	self.cost = nil
	self.event1Cfg = nil
	self.event2Cfg = nil
...
HandCardInfo.ClearBuff = function(self)
	self.e1P1Extra = 0
	self.e1P2Extra = 0
	self.e2P1Extra = 0
	self.e2P2Extra = 0
...
HandCardInfo.TryAddBuff = function(self, buff, roundOrGame, index)
	local isAdd = false
	...
	if isAdd then
		if roundOrGame then
			self.AddRoundBuff(self, index)
		else
			self.AddGameBuff(self, index)
		end
	end
end

HandCardInfo.AddRoundBuff = function(self, index)
	table.insert(self.roundBuffList, index)
end

HandCardInfo.AddGameBuff = function(self, index)
	table.insert(self.gameBuffList, index)
end

HandCardInfo.GetCost = function(self)
