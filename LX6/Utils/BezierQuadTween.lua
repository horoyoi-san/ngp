-- Original chunk: @Lua\LuaFiles\LX6\Utils\BezierQuadTween.lua
-- Decompiled from: 00082_BezierQuadTween.lua_599648c17372.luajit
...
BezierQuadTween.update = function(self, dt)
	if self.t >= 1 then
...
BezierQuadTween.new = function(p0, p1, p2, duration, easing)
	local obj = {
		["\\xd9"] = 0,
		P0 = p0,
		P1 = p1,
...
BezierQuadTween.SetP2 = function(self, p2)
	self.P2 = p2
end
