-- Original chunk: @Lua\LuaFiles\LX6\Manager\Map\MapSubSystem\MapSubSystem_CollectionType5.lua
-- Decompiled from: 02325_MapSubSystem_CollectionType5.lua_1c0c46c0aed2.luajit
...
M.Tick = function(self)
	...
	for id, entry in pairs(self._gpsEntries) do
		...
		local pos = element.GetWorldPos(element)
		local dx = x - pos.x
		local dy = y - pos.y
		local dz = z - pos.z
