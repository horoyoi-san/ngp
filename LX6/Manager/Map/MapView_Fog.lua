-- Original chunk: @Lua\LuaFiles\LX6\Manager\Map\MapView_Fog.lua
-- Decompiled from: 00203_MapView_Fog.lua_c69ea6a85c38.luajit

local RaidConfig = LTConfig.RaidConfig
MapView = MapView or {}
local M = MapView

M.SetFogEnable = function(self, enable)
...
M.InFog = function(self, instanceId)
