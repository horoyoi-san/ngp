-- Original chunk: @Lua\LuaFiles\LX6\Manager\Map\MapView_Conflict.lua
-- Decompiled from: 00207_MapView_Conflict.lua_17b093dc0e57.luajit

MapView = MapView or {}
local M = MapView

M.InitConflictStageRuleContext = function(self, ruleContext)
	ruleContext.bindRootId2ConflictMask = {}
end

M.ConflictStageCheck = function(self, instanceId, ruleContext)
...
M.ConflictStageRuleFullUpdate = function(self, allItems, ruleContext)
