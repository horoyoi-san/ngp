-- Original chunk: @Lua\LuaFiles\LX6\Manager\Dialog\DialogCameraManager.lua
-- Decompiled from: 00509_DialogCameraManager.lua_4ea5e58bd84b.luajit
...
M.OnBeforeSwitchScene = function(self, switchType)
	...
	C_DCTManager:OnBeforeSwitchScene(switchType)
end

M.GetDCTConfig = function(self)
	return C_DCTManager:GetDCTConfig()
end

M.ParseRealUnitInfo = function(self, bindUnitInfos, spoonNode, spoonContext, spoonGraph)
...
M.ParseBindCarInfo = function(self, data, BindCarInfo, BindSeatInfo)
	local bindInfos = {}
...
M.ParseAdvancedBlackContinue = function(self, data, AdvancedBlackContinue)
...
M.ProcessBlackScreenWhenStart = function(self)
...
M.InvokeAction = function(self, action)
