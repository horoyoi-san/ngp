-- Original chunk: @Lua\LuaFiles\LX6\Manager\GamePlay\ChallengePlay\ChallengePlayManager.lua
-- Decompiled from: 02183_ChallengePlayManager.lua_80d28aae0b0f.luajit
...
M.StartPlay = function(self, nodeId, allGadgetIdList, successCallback)
	...
	L50.L50App.Scene.SpoonClientMgr:StartGraph(nodeId, nodeId, SPOON_CLIENT_NAME, L50.Spoon.SpoonRunTime.ClientGraphType.TASK_SPOON_CLIENT, true, nil, )
end

M.OnNpcPassBy = function(self, gadgetUId)
...
M.StopPlay = function(self, nodeId)
