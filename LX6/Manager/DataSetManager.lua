-- Original chunk: @Lua\LuaFiles\LX6\Manager\DataSetManager.lua
-- Decompiled from: 00157_DataSetManager.lua_6ac5c190af5e.luajit
...
local M = {
	...
	TryGetOrCreateUnitData = function (self, pid)
		if self.units[pid] ~= nil then
			...
			if csunit then
				self.CreateUnitData(self, pid, csunit.IsMe, csunit)
			end
		end
	...
	ReBindMyUnit = function (self, pid)
		...
		local data = self.TryGetOrCreateUnitData(self, pid)
