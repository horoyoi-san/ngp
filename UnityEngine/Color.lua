-- Original chunk: @Lua\LuaFiles\UnityEngine\Color.lua
-- Decompiled from: 00008_Color.lua_f28d0e743e4d.luajit
...
Color.NewByStr = function(colorStr)
	local r = tonumber(string.sub(colorStr, 1, 2), 16)
	local g = tonumber(string.sub(colorStr, 3, 4), 16)
	local b = tonumber(string.sub(colorStr, 5, 6), 16)
	local a = tonumber(string.sub(colorStr, 7, 8), 16) or 255
...
Color.RGBToHSV = function(rgbColor)
	...
	elseif rgbColor.r >= rgbColor.g then
